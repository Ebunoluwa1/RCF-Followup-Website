...
const TestResult = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-11">
      <div>
        <h3 className="text-3xl md:text-4xl font-semibold text-black tracking-wider mb-10 text-center mt-4">
          Congratulations!!
        </h3>
        ...
        <div className="flex flex-col items-center justify-center">
          <TextComponent
            ...
            text="Champion!! You are one step closer."
          />
          <TextComponent
            className="underline ring-offset-4 text-black font-medium cursor-pointer"
            text="Take next lesson"
          />
        </div>
