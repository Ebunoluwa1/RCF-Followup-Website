      ...
      .then((response) => {
        ...
        if (token) {
          localStorage.setItem(
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3MTNjMzlkM2QwZjRjNzQ5YTAwZDcyYSIsImlhdCI6MTcyOTM0ODUxMCwiZXhwIjoxNzI5MzUyMTEwfQ.qegRwOqmnhtxayQaKAo4Acz_SxiRgBjFgsdD8m1DUnM",
            token
          );
        }
          ...
          <form className="w-full space-y-6" onSubmit={(e) => handleSubmit(e)}>
            ...
            <div className="pt-2">
              <ButtonLinks
                ...
                size="md"
                color="primary"
                className={`w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-0 ${
            ...
            {error && <p className="text-red-600">You Are Not Registered</p>}
          </form>
